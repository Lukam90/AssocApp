...
INSERT INTO reservation (status, paid_at, comments, event_id, user_id, mode_id) 
...
INSERT INTO reservation (status, paid_at, comments, event_id, user_id, mode_id) 
VALUES ('Payé', '2023-03-02', 'une table offerte (membre)', 1, 2, 2);
...
INSERT INTO reservation (status, paid_at, comments, event_id, user_id, mode_id) 
VALUES ('A Payer', '2023-03-10', 'réduction sur la 2ème table', 1, 3, 3);
